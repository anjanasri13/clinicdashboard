        ...
        <div className='flex gap-5'>
            <div className='bg-[#C4C4C4] w-[176px] h-[315px] mt-[50px]'>
             ...
             <div  className='bg-[#6D6D6D] w-[279px] h-[345px] mt-[20px]' >
                ...
                mt-[20px] w-[90%] ml-[10px]' onClick={payment}>$<span className='text-[50px]'>30</span>/per month</button>
            ...
            <div  className='bg-[#C4C4C4] w-[176px] h-[315px] mt-[50px]'>
                <p className='text-[18px] font-normal rounded-[30px] border-2 border-black text-center
                mt-[40px] w-[80%] ml-[15px]'>$220/per year</p>
                <p  className='text-[16px] font-medium mt-[25px] ml-[20px]'>Lorem Ipsum is simply dummy text of the printing and has been the </p>
            </div> 
        </div>
        </Box>
      </Modal>
