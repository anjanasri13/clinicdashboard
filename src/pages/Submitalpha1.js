...
<div>
    ...
    <div className=' ml-[90px] mt-[50px] border-2 w-[1346px] h-[430px] bg-[#C4C4C4] rounded-[19px]'> 
                    <img src={login} className='w-[107px] h-[105px] mt-[-60px] pt-[-20px] ml-[610px]'/>
           ...
           <div className='flex '>
              ...
              <div>
                  <img src={cracker} className='w-[114px] h-[114px] ml-[190px] mt-[60px]'/>
                  <p className='text-[25px] font-bold mt-[15px] ml-[150px]'>Congratulation</p>
              </div>
            </div>
    ...
    <div className='w-[1009px] h-[302px] bg-[#C4C4C4]  rounded-[20px] mb-[20px] ml-[300px]'>
                    <p className='text-[24px] font-medium ml-[30px] mt-[30px] pt-[20px]'>Continue</p>
