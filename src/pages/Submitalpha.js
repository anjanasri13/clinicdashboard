        ...
        <Header/>
          <div className='flex justify-between'>
                <div className='w-[428px] h-[800px] bg-[#C4C4C4] rounded-[9px] ml-[20px] mt-[20px] text-center flex flex-col gap-[15px]'>
                    ...
                    <a href='' className='text-[#7C7C7C] text-[25px] font-normal underline underline-offset-1'>Email results</a><br/>
                    <button style={style}>Try Again</button><br/>
                    <button style={style}>Back Home</button><br/>
                    <button style={style}>Subscribe for full version</button>
                </div>

                <div className='w-[900px] h-[352px] bg-[#C4C4C4] mt-[200px] rounded-[9px] '>
                    <p className='text-[24px] font-medium ml-[30px] mt-[30px]'>Next test</p>
