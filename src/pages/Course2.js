...
export default function Course2() {
  ...
  const { title, src,src1, training, subtitle, desc,nxttitle } = location.state || {};
    ...
    <div>
      ...
      <h1 className='text-center text-[20px] mt-[10px] font-normal'>{title}</h1>
       ...
       <div className=' w-[81%] h-[640px] bg-[#D6D6D6B5] mt-[20px] ml-[130px] rounded-[22px] overflow-y-auto	pb-[30px] '>
        ...
        {src && <img src={src} alt="Course Image" className='w-[95px] h-[120px] pt-[25px] ml-[20px]'/>}
        </div>
        <p className='text-[16px] font-medium mt-[20px] ml-[40px] mr-[0px]'>{desc}</p>
      </div>
      <h1 className='text-[30px] font-normal ml-[130px] mt-[20px]'>{nxttitle}</h1>
     
     <div className='flex text-[#DB544A] '>
      <div className=' bg-[#D6D6D6B5] w-[20%] h-[150px] ml-[130px] rounded-[22px] mb-[20px]'>
          <a href=''><FaFilePdf className='w-[50%] h-[50px] ml-[75px] mt-[50px]'/></a>
      </div>
      <div className=' bg-[#D6D6D6B5] w-[20%] h-[150px] ml-[130px] rounded-[22px] mb-[20px]'>
          <a href=''><FaFilePdf className='w-[50%] h-[50px] ml-[75px] mt-[50px]'/></a>
      </div>
